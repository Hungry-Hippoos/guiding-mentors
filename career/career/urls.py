...
urlpatterns = [
    ...
    path('student/<int:student_id>/dashboard/',student_dashboard,name='student_dashboard'),
    path('school/<int:school_id>/dashboard/',school_dashboard,name='school_dashboard'),
